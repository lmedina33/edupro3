...
<title>Asignaci�n de Areas Ocupacionales </title>
  ...
  <tr>
    <td width="830"><table width="833" border="0" align="center" bgcolor="#FFFFFF">
      ...
      <tr>
		...
		<div class="title"> Asignaci�n de Areas Ocupacionales </div>
		</div>
		</div>
              ...
              <tr bgcolor="#F3F3F3">
                <td bordercolor="#000000" bgcolor="#F3F3F3"><br />
                  <table width="776" border="0">
                    <tr>
                      <td width="58">&nbsp;</td>
                      <td width="669"><form id="form1" name="form1" method="get" action="../ocupacional/ocupacional.php">
